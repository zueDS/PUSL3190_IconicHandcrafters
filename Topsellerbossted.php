                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>Items from top rated sellers</p>
                            </div>
                        ...
                        <div class="row product-grid-3">
                            ...
                            $sqlzy34y2 = "SELECT * FROM boostedproducts";
                            $query4y2 = $conn->query($sqlzy34y2);
                            foreach ($query4y2 as $value4y2) {
                                
                                
                                $loadingboosid = $value4y2['itemidtoload'];


                                $sqlzy34 = "SELECT * FROM sellerpostitem where proidgenarated='$loadingboosid'";
