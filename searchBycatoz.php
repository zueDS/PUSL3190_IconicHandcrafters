...
<html class="no-js" lang="en">
    ...
    <main class="main">
        ...
        <?php
        $get_keywrd = $_GET["caridz"];
        $sqlzy3455 = "SELECT * FROM shopcatos where idshopcatos='$get_keywrd'";
        $catonamez = "";
        $query455 = $conn->query($sqlzy3455);
        foreach ($query455 as $value45) {
            $catonamez = $value45['catoname'];
        }
        ?>
                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p>Items matches for &nbsp;&nbsp;&nbsp;&nbsp;<b style="color: black;"> <?php echo $catonamez; ?></b></p>
                            </div>
                        ...
                        <div class="row product-grid-3">
                            ...
                            $sqlzy34 = "SELECT * FROM sellerpostitem where statusz='Accept' and category='$catonamez'  ORDER BY itemidsellerpost DESC";
