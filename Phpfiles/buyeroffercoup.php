...
$sqlupdatezzzz2 = "update buyerratingz set ratingpoints=ratingpoints+'$sellerrate' where buyeridz='$sellerz_emailz'";
...
if ($conn->query($ssql) === TRUE && $conn->query($sqlupdatezzzz2) === TRUE && $conn->query($sqlqqmessage) === TRUE) {
