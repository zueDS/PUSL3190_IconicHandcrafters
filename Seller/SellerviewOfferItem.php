    ...
    <body>
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($query4 as $value4) {
                                           ...
                                           <td><button class="btn btn-danger" onclick="removeofferz(<?php echo $value4['itemidsellerpost']; ?>)">Remove offer</button></td>
                                            </tr>
                                            <?php
                                        }
                                    }
        ...
        <script>
                                        ...
                                        function removeofferz(dd) {
                                            ...
                                            swal({
                                                title: "Are you sure?",
                                                text: "You want remove this offer...?",
                                                icon: "warning",
                                                buttons: true,
                                                dangerMode: true,
                                            })
                                                    .then(function(willDelete) {
                                                        if (willDelete) {
                                                            ...
                                                            $.post("../phpfiles/SellerRemoveoffer.php",
                                                                    {
                                                                        userid: userid
