    ...
    <body>
                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sqlzy34 = "SELECT DISTINCT itemidz FROM itemhasreview where selleremailz='$sellerz_emailz'";
                                        ...
                                        foreach ($query4 as $value4) {
                                            ...
                                            <input type="hidden" id="itemidz<?php echo $value4z['itemidsellerpost']; ?>" value="<?php echo $proID; ?>">
                                            <td><button class="btn btn-success" onclick="openlinkinnewTab(<?php echo $value4z['itemidsellerpost']; ?>)">View Reviews</button></td>
        ...
        <script>
                                                function openlinkinnewTab(dd) {
                                                    ...
                                                    var url = "viewsingleitemsreviews.php?proidz=" + idgenarated
                                                    window.open(url);
