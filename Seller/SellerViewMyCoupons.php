...
<html lang="en">
    ...
    <head>
        ...
        <title>Seller view coupons offered </title>
    ...
    <body>
                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>View coupons</span></li>
                                </ol>
                            </nav>
        ...
        <script>
            function payforcoupon(dd) {
                ...
                var buyerenamez = $('#buyernamez').val();
                ...
                if (coupounpricez == "") {
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "You want to pay for the coupon  LKR " + coupounpricez + "/= ?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
