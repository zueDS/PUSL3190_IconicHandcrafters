                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>View messages</span></li>
                                </ol>
                            </nav>
                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sqlzy3455 = "SELECT * FROM messages_buyer_to_seller where selleremail='$sellerz_emailz' ORDER BY id DESC";
                                        $isellerrank = 0;
                                        ...
                                        foreach ($query455 as $value45) {
                                            ...
                                            <tr>
                                                ...
                                                <td id="buyernn<?php echo $value45['id']; ?>"><?php echo $value45['buyername']; ?></td>
                                                <td id="buyeremm<?php echo $value45['id']; ?>"><?php echo $value45['buyeremail']; ?></td>
                                                <td><?php echo $value45['messagez']; ?></td>
                                                <td><?php echo $value45['datez']; ?></td>
                                                <td><?php echo $value45['timez']; ?></td>
                                                <td><button class="btn btn-info" onclick="sellermeszz(<?php echo $value45['id']; ?>)">Send reply</button></td>
                                                <?php
                                                if ($value45['statuz'] == "notread") {
                                                    ?>
                                                    <td><button class="btn btn-success" onclick="messagemarkasread(<?php echo $value45['id']; ?>)">Mark as read</button></td>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <td></td>   
