...
<html lang="en">
    ...
    <head>
        ...
        <title>Seller view removed products </title>
    ...
    <body>
                        ...
                        <div class="page-header">
                            ...
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><span>My removed listings</span></li>
                                </ol>
                            </nav>
                            ...
                            <div class="widget-content widget-content-area br-6">
                                ...
                                <table id="zero-config" class="table dt-table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $sqlzy34 = "SELECT * from sellerpostitem where selleremailz='$sellerz_emailz' and statusz='removed'";
                                        ...
                                        foreach ($query4 as $value4) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value4['sizez']; ?></td>
                                                <td><?php echo $value4['colors']; ?></td>
                                        ...
                                        <td><button class="btn btn-success" onclick="activelisting(<?php echo $value4['itemidsellerpost']; ?>)">Active listing</button></td>
        ...
        <script>
                                            ...
                                            function activelisting(dd) {
                                                ...
                                                swal({
                                                    title: "Are you sure?",
                                                    text: "You want to active this listing...?",
                                                    icon: "warning",
                                                    buttons: true,
                                                    dangerMode: true,
                                                })
                                                        .then(function(willDelete) {
                                                            if (willDelete) {
                                                                ...
                                                                $.post("../phpfiles/SellerActivelistings.php",
                                                                        {
                                                                            userid: userid
                                                                ...
                                                                function(data, status) {
                                                                    if (data == "ok") {
                                                                        ...
                                                                        swal("Done! Listing activated..!", {
                                                                            icon: "success",
                                                                        });

                                                                        window.location = "SellerremoveListing.php";
