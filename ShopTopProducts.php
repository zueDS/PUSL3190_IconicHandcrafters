                    ...
                    <div class="col-lg-9">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> Here are the best sold items for you!</p>
                            </div>
...
GROUP BY
  itemidgenarated ";
                            $querysqltoprate = $conn->query($sqltoprate);
                            foreach ($querysqltoprate as $valuetoprate) {

                                $item_toprated = $valuetoprate['itemidgenarated'];


                                $sqlzy34 = "SELECT * FROM sellerpostitem where statusz='Accept' and proidgenarated='$item_toprated' ORDER BY itemidsellerpost DESC";
