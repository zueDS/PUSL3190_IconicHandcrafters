...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin View Seller Ratings</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All  Sellers Ratings</h4>
                                        <p class="card-title-desc">Here you can view all  Sellers details and statistics
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <input type="hidden" id="sellerid<?php echo $value45['id_user']; ?>" value="<?php echo $value45['email']; ?>">
                                                    <td> <button class="btn btn-info waves-effect waves-light" onclick="loadStas(<?php echo $value45['id_user']; ?>)">View stats</button></td>
    ...
    <script>
                                    ...
                                    function loadStas(dd) {
                                        ...
                                        window.open("SingleviewSellerstats.php?selleremailz=" + emailzofseller);
