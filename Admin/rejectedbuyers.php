                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All rejected buyer Details</h4>
                                        <p class="card-title-desc">Here you can view all rejected buyer details
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM user_details where userstatus='Removed' and usertype='Buyer'";
