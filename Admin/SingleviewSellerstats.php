...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin single View Seller Ratings</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Items posted by seller</h4>
                                        <p class="card-title-desc">Here you can view all the items posted by seller 
                                        </p>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                $seller_id_loadingz = $_GET["selleremailz"];

                                                $sqlzy34 = "SELECT * FROM solitems where selleremail ='$seller_id_loadingz'";
                                        ...
                                        <center>
                                            <p class="card-title-desc" style="font-size: 25px;color: orange;">Total items sold by this seller is <?php echo $totalitem; ?> 
                                            </p>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Reviews gained by this seller</h4>
                                        <p class="card-title-desc">Here you can view all the reviews gained by this seller
                                        </p>
                                        ...
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <?php
                                                $sqlzy34z = "SELECT * FROM itemhasreview where selleremailz ='$seller_id_loadingz'";
                                                ...
                                                foreach ($query4z as $value4z) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td ><?php echo $value4z['postedusername']; ?></td>
                                                        <td ><?php echo $value4z['posteduseremail']; ?></td>
                                        ...
                                        <center>
                                            <p class="card-title-desc" style="font-size: 25px;color: orange;">Total reviews gained by this seller is <?php echo $totalitemz; ?> 
                                            </p>
                                        </center>
                                    </div>
                                </div>
