...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin View rejected buyers</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All rejected Sellers Details</h4>
                                        <p class="card-title-desc">Here you can view all rejected Sellers details
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM user_details where userstatus='Removed' and usertype='Seller'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['usertype']; ?></td>
                                                        <?php
