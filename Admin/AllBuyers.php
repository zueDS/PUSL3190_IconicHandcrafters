...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin view all buyers</title>
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All buyers</h4>
                                        <p class="card-title-desc"> Here are the all registered buyers.
                                        </p>
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM user_details where usertype='Buyer'";
                                                    ...
                                                    foreach ($query4 as $value4) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            if ($stateofuser == "Active") {
                                                                ...
                                                                <td> <button class="btn btn-danger waves-effect waves-light" onclick="RemoveUser(<?php echo $value4['id_user']; ?>)">Remove user</button></td>
                                                                <?php
                                                            } else if ($stateofuser == "Removed") {
                                                                ?>
                                                                <td><span class="badge rounded-pill bg-danger"><?php echo $stateofuser; ?> </span></td>
                                                                <td> <button class="btn btn-success waves-effect waves-light" onclick="ActiceUser(<?php echo $value4['id_user']; ?>)">Active user</button></td>
                                                                <?php
                                                            }
                                                            ?>
        ...
        <script>
                                    function RemoveUser(dd) {
                                        ...
                                        swal({
                                            title: "Are you sure?",
                                            text: "You want to remove this buyer ?",
                                            icon: "warning",
                                            buttons: true,
                                            dangerMode: true,
                                        })
                                    ...
                                    function ActiceUser(dd) {
                                        ...
                                        swal({
                                            title: "Are you sure?",
                                            text: "You want to activate this buyer ?",
                                            icon: "warning",
                                            buttons: true,
                                            dangerMode: true,
                                        })
