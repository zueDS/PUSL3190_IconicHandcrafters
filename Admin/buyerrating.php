...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin View buyer Ratings</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All  buyer Ratings</h4>
                                        <p class="card-title-desc">Here you can view all  buyer details and statistics
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM buyerratingz ORDER BY ratingpoints DESC";
                                                $query4 = $conn->query($sqlzy34);
                                                $isellerrank = 0;
                                                foreach ($query4 as $value4) {
                                                    $isellerrank++;
                                                    $buyer_ratingz = $value4['buyeridz'];

                                                    $sqlzy3455 = "SELECT * FROM user_details where email='$buyer_ratingz'";
                                                    $statuzofutem = "";
                                                    ...
                                                    foreach ($query455 as $value45) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $value4['ratingpoints']; ?></td>
                                                            <?php
                                                            if ($value4['ratingpoints'] >= 0 && $value4['ratingpoints'] < 100) {
                                                                ?>
                                                                <td><span class="badge rounded-pill bg-success"><b>1</b></span></td>
                                                                <?php
                                                            } else if ($value4['ratingpoints'] >= 100 && $value4['ratingpoints'] < 300) {
                                                                ?>
                                                                <td><span class="badge rounded-pill bg-success"><b>2</b></span></td>
                                                                <?php
                                                            } else if ($value4['ratingpoints'] >= 300 && $value4['ratingpoints'] < 600) {
                                                                ?>
                                                    ...
                                                    <input type="hidden" id="buyeridz<?php echo $value45['id_user']; ?>" value="<?php echo $value45['email']; ?>">
                                                    <td> <button class="btn btn-info waves-effect waves-light" onclick="loadStasz(<?php echo $value45['id_user']; ?>)">View stats</button></td>
    ...
    <script>
                                    ...
                                    function loadStasz(dd) {

                                        var userid = dd;

                                        var emailzofseller = $('#buyeridz' + dd).val();
                                        window.open("Singleviewbuyerstats.php?buyeremailz=" + emailzofseller);
