                                ...
                                <div class="card">
                                    <div class="card-body">
                                                    ...
                                                    if ($row = $result->fetch_assoc()) {
                                                        ...
                                                        foreach ($query455 as $value4) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <?php
                                                                if ($orderstat == "Notready") {
                                                                    ?>
                                                                    <td><label class="label label-warning"><span class="badge rounded-pill bg-warning">Not ready </span></label></td>
                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                    <td><label class="label label-success"><span class="badge rounded-pill bg-success">Ready</span></label></td>
                                                                    <?php
                                                                }
                                                                ?>

                                                                <td><button class="btn btn-info" onclick="buyerrmeszz(<?php echo $value4['idorderdetails']; ?>)">Message seller</button></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                    }
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <select  id="input-district" class="form-control" onchange="LoadCityz()">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Select Delivery person</label>
                                            <div class="col-md-10">
                                                <select name="country_id" id="input-city" class="form-control" onchange="Loaddelpersonz()">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Person city</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" id="loadpersoncity" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Person Email</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" id="loadpersonemail" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Person NIC</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" id="loadpersonnic" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Person Contact 1</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" id="loadpersoncontact" />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Person Contact 2</label>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control" disabled="" id="loadpersoncontact2" />
                                            </div>
                                        </div>
                                        <center>
                                            <button class="btn btn-success" onclick="assignorderz()">Assign order to this person</button>
                                        </center>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        if (getval == "Select District" || getval2 == "None") {
                                            ...
                                            function(data, status) {
                                                if (data == "ok") {
                                                    ...
                                                    window.location = "AdminViewAssignedordes.php";
