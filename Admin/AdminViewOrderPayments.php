                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-title-desc"> Here are the completed Orders that you have.
                                        </p>
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM orderz where statusz='completed' ORDER BY idorderz DESC";
                                                    ...
                                                    foreach ($query4 as $value4) {
                                                        ...
                                                        $v1 = $value4['orderdelcost'];
                                                        $v2 = $value4['ordernetcost'];
                                                        $flo1 =(float)$v1;
                                                        $flo2 =(float)$v2;
                                                        
                                                        $delcostoadz = $delcostoadz +$v1;
                                                    ...
                                                    <td>LKR <?php echo $value4['ordersubz']; ?> </td>
                                                    <td>LKR <?php echo $value4['orderdelcost']; ?> </td>
                                                    <td>LKR <?php echo $value4['ordernetcost']; ?> </td>
                                                    <td> <button class="btn btn-success waves-effect waves-light" onclick="ViewPendingOrderdetails(<?php echo $value4['idorderz']; ?>)">Order details</button></td>
...
?>
                                            ...
                                            <center>
                                            <label style="font-size: 25px;">Your total cost of  the Order are LKR <?php echo $nettotalloadz; ?> /=</label>
                                            <br>
                                            <label style="font-size: 25px;">Your total cost of  the delivery cost  are LKR <?php echo $delcostoadz; ?> /=</label>
                                            </center>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
                                    function ViewPendingOrderdetails(cc) {
                                        ...
                                        var orderid = cc;
                                        var url = "SingleviewOrderz.php?orderid=" + orderid;
