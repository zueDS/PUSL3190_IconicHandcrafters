...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin View subscribed Users</title>
                            ...
                            <div class="col-sm-6">
                                <div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">All subscribed User details</li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">All subscribed User Details</h4>
                                        <p class="card-title-desc">Here you can view all subscribed user details
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                $incez = 0;
                                                $sqlzy34 = "SELECT * FROM subscriptions";
