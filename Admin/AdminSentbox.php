                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title">Messages to sellers</h4>
                                        <p class="card-title-desc">Here you can view all sent messages to seller
                                        </p>
...
<!--                                                        <th>Date Remaining for payment</th>-->
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM messages_buyer_to_seller where buyeremail='admin@iconichandcrafters.com'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                  ...
                                                  $usdi++;
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['messagez']; ?></td>
