                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sqlzy34 = "SELECT * FROM shopcatos";
                                                    $query4 = $conn->query($sqlzy34);
                                                    foreach ($query4 as $value4) {

                                                        $sta_cato = $value4['statusz'];
                                                        ?>
                                                        <tr>

                                                            <td><?php echo $value4['catoname']; ?></td>
                                                            <td><img class="rounded me-4" alt="200x200" width="128" src="../phpfiles/<?php echo $value4['imgiconz']; ?>" data-holder-rendered="true"></td>
                                                            <?php
                                                            if ($sta_cato == "Active") {
                                                                ?>

                                                                <td><span class="badge bg-success" style="font-size: 20px;">Active</span></td>
                                                                <td><button class="btn btn-lg btn-danger" onclick="Removecategory(<?php echo $value4['idshopcatos']; ?>)">Remove</button></td>
                                                                <?php
                                                            } else {
                                                                ?>
                                                                <td><span class="badge bg-danger" style="font-size: 20px;">Removed</span></td>
                                                                <td><button class="btn btn-lg btn-success" onclick="ActiveRemoved(<?php echo $value4['idshopcatos']; ?>)">Active</button></td>
                                                                <?php
                                                            }
                                                            ?>
                                                        </tr>
